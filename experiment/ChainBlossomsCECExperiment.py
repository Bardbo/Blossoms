...
nodes = [
    AlgorithmParam("A", ea.soea_EGA_templet, {"NIND":50, "MAXGEN":40}),
    AlgorithmParam("B", soea_PSO_templet, {"NIND":50, "MAXGEN":40}),
    AlgorithmParam("C", soea_JADE_currentToBest_1_bin_templet, {"NIND":50, "MAXGEN":40}),
    AlgorithmParam("D", soea_L_SHADE_currentToBest_1_bin_templet, {"NIND":50, "MAXGEN":40}),
    AlgorithmParam("E", soea_AGSK_templet, {"NIND":50, "MAXGEN":40}),
]
