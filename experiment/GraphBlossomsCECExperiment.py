...
nodes = [
    AlgorithmParam("A", ea.soea_EGA_templet, {"NIND":10, "MAXEVALS":2000}),
    AlgorithmParam("B", soea_PSO_templet, {"NIND":10, "MAXEVALS":2000}),
    AlgorithmParam("C", soea_JADE_currentToBest_1_bin_templet, {"NIND":10, "MAXEVALS":2000}),
    AlgorithmParam("D", soea_AGSK_templet, {"NIND":10, "MAXEVALS":2000}),
    AlgorithmParam("E", soea_L_SHADE_currentToBest_1_bin_templet, {"NIND":10, "MAXEVALS":2000}),
]
